...
void iconDispGxAlpha(float scale, Vec3 * position, int param_3, s32 iconId, u8 alpha); // 80072ea8
void iconDispGx(float scale, Vec3 * position, int param_3, s32 iconId); // 800731b0
void iconDispGx2(Mtx34 * param_1, int param_2, s32 iconId); // 800731b8
void iconDispGxCol(Mtx34 * param_1, int param_2, s32 iconId, void * param_4); // 80073444
void iconGetTexObj(GXTexObj * dest, s32 iconId); // 800736b4
void iconGetTexObj2(GXTexObj * dest, s32 iconId, int param_3, int param_4); // 80073844
